...
return [
    ...
    */
    ...
    "A fresh verification link has been sent to your email address." => "Một đường dẫn xác minh mới đã được gửi đến địa chỉ email của bạn.",
    "All rights reserved." => "All rights reserved",
    "Before proceeding, please check your email for a verification link." => "Trước khi tiếp tục, hãy kiểm tra email của bạn để truy cập vào liên kết xác minh",
    "click here to request another" => "click vào đây để gửi một yêu cầu khác",
    ...
    "If you’re having trouble clicking the \"=>actionText\" button, copy and paste the URL below\ninto your web browser=> [=>actionURL](=>actionURL)" => "Nếu bạn gặp vấn đề khi click vào nút \"=>actionText\", hãy sao chép dán địa chỉ bên dưới\nvào trình duyệt web của bạn=> [=>actionURL](=>actionURL)",
    "Login" => "Đăng nhập",
    "Logout" => "Đăng xuất",
    "Name" => "Tên",
    "Oh no" => "Oh, không",
    ...
    "Sorry, the page you are looking for could not be found." => "Rất tiếc, trang bạn đang tìm kiếm không thể tìm thấy.",
    "Sorry, you are forbidden from accessing this page." => "Xin lỗi, bạn không có quyền truy cập vào trang này.",
    "Sorry, you are making too many requests to our servers." => "Xin lỗi, bạn đang thực hiện quá nhiều yêu cầu cho máy chủ của chúng tôi.",
