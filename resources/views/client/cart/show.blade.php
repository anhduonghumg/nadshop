    ...
    <div class="container-fluid">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3">
                ...
                <a href="{{ route('client.cart.checkout') }}" class="form-control btn btn-dark mb-2">Tiến hành đặt
                    hàng</a>
    ...
    <script type="text/javascript">
        ...
        function load_cart() {
            if (localStorage.getItem('data_cart') != null) {
                ...
                let html =
                    `<tr><td>Giỏ hàng trống.Nhấn vào đây để mua sắm <a href="http://localhost/nadshop">shopping now</a></td></tr>`;
                $('#show_cart').html(html);
            }
        }
        ...
        function render_cart() {
            ...
            if (data.length > 0) {
                $.each(data, function(key, value) {
                    ...
                    var path_img = asset("storage/app/public/images/product/detail/") + value.thumbnail;
