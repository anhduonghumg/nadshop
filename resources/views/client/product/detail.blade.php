    ...
    <div class="row">
        ...
        <div class="col-5 pb-5">
            ...
            <h3 class="font-weight-semi-bold mb-4">
                {{ currentcyFormat($product->product_price - ($product->product_price * $product->product_discount) /
                100) }}
            </h3>
            <div class="mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <form>
                                ...
                                <div class="form-group mb-0">
                                    <button id="add_comment" type="button" value="" class="btn btn-primary px-3">Gửi
                                        bình luận</button>
                                </div>
                            </form>
                        </div>
