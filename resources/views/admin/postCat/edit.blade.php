...
@section('title', 'Cập nhập danh mục bài viết')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @endif
                    <div class="card-body">
                        <form action='{{ url("admin/post/cat/update/$catPost->id") }}' method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name">Tên danh mục</label>
                                <input class="form-control @error('name') is-invalid @enderror" type="text" name="name"
                                    id="name" value="{{ $catPost->name }}">
                                @error('name')
