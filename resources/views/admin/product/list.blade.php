                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @else
                            <td>
                                <button type="button" class="btn btn-primary btn-sm rounded-0 text-white"
                                    data-toggle="modal" data-target="#myModal" data-placement="top"
...
<div class="modal fade draggable" id="myModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
