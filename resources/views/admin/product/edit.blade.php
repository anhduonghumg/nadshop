                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="product_content" class="form-control" id="intro" cols="30" rows="5">{{ $product->product_content }}</textarea>
                            ...
                            <div class="form-group">
                                <input type="checkbox" name="product_new" id="product_new"
                                    value="{{ $product->is_product_new }}"
                                    @if ($product->is_product_new == Constants::TRUE) return
                            'checked' @endif>
                                <label for="product_new">Sản phẩm mới</label>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" name="product_best_seller" id="product_best_seller"
                                    value="{{ $product->is_product_best_seller }}"
                                    @if ($product->is_product_best_seller == Constants::TRUE) return 'checked' @endif>
